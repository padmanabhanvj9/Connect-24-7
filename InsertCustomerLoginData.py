...
def insertcustomerlogindata(request):
     ...
     gcm_senderid  = request.json['gcm_senderid']
     ...
     sql = "insert into customer_login values("+business_login_id+",'"+customer_login_mobile+"','"+customer_login_user+"','"+customer_login_datetime+"','"+customer_login_email+"','"+customer_login_activity+"','"+gcm_senderid+"')"
     cur.execute(sql)
     con.commit()     
