...
#from InsertBusinessPrimaryData import insertbusinessprimary
...
#@app.route('/InsertBusinessPrimaryData',methods=['POST'])
#def insertbusinessprimarydata():
#   return insertbusinessprimary(request)
