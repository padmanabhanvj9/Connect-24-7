...
def sendemailiani(request):
     ...
     r = requests.post('https://ivrinfocuit.herokuapp.com/FetchExistingBookings', json={"conf_no":conf_no}
     res = r.json()
     name = res['customer_name']
     email = "infocuit.banupriya@gmail.com"
     message = "Booking Confirmed"
     conf_no = res['customer_confirmation_number']
     hotel_name = "SMARTMO"
     arrival = res['customer_arrival_date']
     depature = res['customer_depature_date']
     room_type = res['customer_room_type']
